    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilesHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FilesHistory_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilesHistory_Users_ModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Permissions_Users_GrantedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilesHistory_FileId",
                table: "FilesHistory",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_FilesHistory_ModifiedById",
                table: "FilesHistory",
                column: "ModifiedById");
